![1566805219205](第二单元 DNS服务（一）.assets/1566805219205.png)
...
![1566871298785](第二单元 DNS服务（一）.assets/1566871298785.png)

![1566871375792](第二单元 DNS服务（一）.assets/1566871375792.png)
...
![1566827231762](第二单元 DNS服务（一）.assets/1566827231762.png)
...
![1566876057134](第二单元 DNS服务（一）.assets/1566876057134.png)
...
![1566877504045](第二单元 DNS服务（一）.assets/1566877504045.png)



#### 1.1.6 DNS 解析类型

提供域名域主机 IP 地址的对应关系数据库，分为正向解析和反向解析
① 正向解析：将域名解析为对应的 IP,这是 DNS 服务器最基本的功能，也是最常用的功能
② 反向解析：把 IP 解析为对应的域名
邮件服务可能会用到域名反向解析结果实施访问控制策略；若缺少对应的反向解析记录可能会被列入“黑名单”中，导致接收不到邮件！
